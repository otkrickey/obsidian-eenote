...
<!-- Post listening comprehension questions. 1.1s A multiple choice questions. 1.1s Listen to the questions and provide your answers. 1.7s Question one what was the NAV garage designed for? 2.8s Question two which of the following was not one of the Navgarod's weaknesses? 2.8s Question three what eventually happened to the Navgarod? 2.8s B true false questions. 1.1s Listen to the questions and write t if the answer is true and F if the answer is false. 1.7s Question one the wind Canon was unusual mainly because of its size. 2.9s Question two the length of the Wind Canon was 1 meter. 2.7s Question three during testing, the Wind Can Own was a success. 5s -->
